...
export function CounsellorSidebar({ user }: Props) {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 py-5 border-b border-sage-100">
        ...
        <div className="mt-1 text-xs text-slate font-medium">Counsellor Portal</div>
      </div>
  ...
  return (
    <>
      {/* Mobile hamburger button — shown when sidebar closed */}
      <button
